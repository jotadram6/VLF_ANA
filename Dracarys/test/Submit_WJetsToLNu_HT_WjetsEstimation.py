...
for i in ListOfSamples:
    ...
    cmd.getoutput('sed -i -- "s/CMSCONFIG/Wpjets_Estimation_MC_cfg.py/g" '+WorkingFolder+'/Crab_'+UsefulString+'.py')
    cmd.getoutput('sed -i -- "s#OUTPUTDIR#jruizalv/VLF_ANA/WJetsEstimation/WJets_HT#g" '+WorkingFolder+'/Crab_'+UsefulString+'.py')
