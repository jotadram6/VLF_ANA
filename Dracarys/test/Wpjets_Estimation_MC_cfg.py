...
process.demo = cms.EDAnalyzer('Dracarys',
                              ...
                              TriggerPath2 = cms.string("HLT_IsoMu24"),
                              #Cuts
                              Pvtx_ndof_min   = cms.int32(4), #Vertices DOF
                              Pvtx_vtx_max  = cms.double(24.),
                              Pvtx_vtxdxy_max = cms.double(24.),
                              MinMuonPt = cms.double(30.0), #Min muon pt - for all muons -
                              MaxMuonPt = cms.double(9999.0), #Max muon pt - for all muons -
                              ...
                              MinMET = cms.double(110.0), #Min MET
